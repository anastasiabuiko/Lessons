...
public class ApiForecast {
    ...
    public ApiForecast  withApiKey(String api) {
        parametrs += "&appid=" + api;
        return this;
    }

    public  ApiForecast withExclude(Excludes... exclude) {
    ...
    public ApiForecast withCoordinates(Double latitude, Double longitude) {
    ...
    public ApiForecast  withCity(String cityName) {
        if (parametrs.endsWith("?")) {
